...
const enUS = {
  ...
  canvas: {
    ...
    help: {
      ...
      spacePan: 'Space + drag / middle-mouse drag: Pan canvas',
      ctrlWheel: 'Ctrl + wheel: Zoom canvas',
      ctrlDrag: 'Ctrl + drag background: Box select',
      ctrlClick: 'Ctrl + click node: Multi-select',
      ctrlZ: 'Ctrl + Z: Undo',
      ctrlShiftZ: 'Ctrl + Shift + Z: Redo',
      ctrlD: 'Ctrl + D: Duplicate selection',
      ctrlA: 'Ctrl + A: Select all',
      ctrlS: 'Ctrl + S: Save canvas',
      ctrlL: 'Ctrl + L: Edit canvas title',
      delete: 'Delete / Backspace: Delete selection',
      escape: 'Escape: Deselect / cancel connection / close menu',
      close: 'Close',
    },
  },
