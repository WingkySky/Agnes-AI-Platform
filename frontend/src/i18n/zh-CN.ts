...
const zhCN = {
  ...
  canvas: {
    ...
    help: {
      title: '快捷键',
      spacePan: 'Space + 拖动 / 中键拖动：平移画布',
      ctrlWheel: 'Ctrl + 滚轮：缩放画布',
      ctrlDrag: 'Ctrl + 拖动背景：框选节点',
      ctrlClick: 'Ctrl + 点击节点：多选',
      ctrlZ: 'Ctrl + Z：撤销',
      ctrlShiftZ: 'Ctrl + Shift + Z：重做',
      ctrlD: 'Ctrl + D：复制选中节点',
      ctrlA: 'Ctrl + A：全选节点',
      ctrlS: 'Ctrl + S：保存画布',
      ctrlL: 'Ctrl + L：编辑画布标题',
      delete: 'Delete / Backspace：删除选中',
      escape: 'Escape：取消选中 / 取消连线 / 关闭菜单',
      close: '关闭',
    },
  },
