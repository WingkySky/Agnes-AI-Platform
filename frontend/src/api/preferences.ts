 ...
 *   generation    : { default_image_model_id, default_video_model_id, default_chat_model_id, default_aspect_ratio, default_image_tier, default_video_resolution, auto_copy_prompt, default_image_count }
