...
export const DEFAULT_MENU_CONFIG: MenuItemConfig[] = [
  ...
  { key: 'projects', show_in_top: true, show_in_sidebar: true, top_group_key: 'create', sidebar_group_key: 'create', top_sort_order: 6, sidebar_sort_order: 6 },
  { key: 'scene-editor', show_in_top: true, show_in_sidebar: true, top_group_key: 'create', sidebar_group_key: 'create', top_sort_order: 7, sidebar_sort_order: 7 },
  ...
  { key: 'presets', show_in_top: false, show_in_sidebar: true, top_group_key: null, sidebar_group_key: 'create', top_sort_order: 99, sidebar_sort_order: 7 },
